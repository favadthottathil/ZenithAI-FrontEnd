  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        reason: 'TextField should be within the visible screen before the keyboard opens',
      );
      ...
      expect(
        ...
        reason: 'TextField should remain above the keyboard, not hidden behind/below it',
      );
